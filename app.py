...
from phone_history import phone_history_bp
...
def create_app():
    ...
    def _desired_host_for_request() -> str | None:
        ...
        # Receipts are public and may be opened from either dashboard or a store.
        # Preserve the current host so its session cookie remains available.
        if endpoint in {"checkout.invoice_batch_view", "checkout.invoice_view"}:
            return None
    ...
    app.register_blueprint(phone_history_bp)
