...
def _process_checkout_core(
    ...
    try:
        ...
        history_error = validate_phone_history_items(cart, "customer_dashboard_checkout")
        if history_error:
            return jsonify({"success": False, "message": history_error}), 400
