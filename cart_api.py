from phone_history import validate_phone_history_items
...
def _normalize_item(raw):
    ...
    if isinstance(raw.get("phone_history_ack"), str):
        item["phone_history_ack"] = raw["phone_history_ack"]
...
def add_bulk():
    ...
    for r in raw_items:
        ...
        history_error = validate_phone_history_items([item], "dashboard_cart")
        if history_error:
            return jsonify({"success": False, "error": history_error}), 400
